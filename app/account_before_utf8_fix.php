...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        redirectTab(
            $tab,
            '',
            'Phiˆn l…m vi?c kh“ng h?p l?. Vui l•ng th? l?i.'
        );
    }
    ...
    if ($action === 'avatar') {
        ...
        if ($imageInfo === false) {
            redirectTab(
                'avatar',
                '',
                'T?p t?i lˆn kh“ng ph?i hnh ?nh h?p l?.'
            );
        }
...
<title>T…i kho?n - VI?T HAN WMS</title>
